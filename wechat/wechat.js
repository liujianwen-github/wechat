...
Wechat.prototype.fetchAccessToken = function(){
	...
	this.getAccessToken().then(function(data){
		...
		request({url:"https://api.weixin.qq.com/cgi-bin/ticket/getticket?access_token="+data.access_token+"&type=jsapi",json:true}).then(function(response){
			var ticketRes = response.body;
			var jsapi_ticket = ticketRes.ticket
